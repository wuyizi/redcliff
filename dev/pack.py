...
CSS_LINK = r'<link rel="stylesheet" type="text/css" href="http://redcliff.googlecode.com/svn/trunk/dev/media/redcliff.css?bpc=2011"></link>'

REDCLIFF_JS_LINK = r'<script src="http://redcliff.googlecode.com/svn/trunk/dev/javascript/redcliff.js?bpc=2011" type="text/javascript"></script>'
